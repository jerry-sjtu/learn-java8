 ...
 */
@Slf4j
public class DpParallelInference {
    private Model model;
    private long nanos;
    private int workers;
...
//        return output(dataSet.getFeatureMatrix());
    ...
    public static class Builder {
         ...
         * @return
         */
        public DpParallelInference build() {
            DpParallelInference inference = new DpParallelInference();
        ...
        public void run() {
            try {
                ...
                while (shouldWork.get()) {
                    InferenceObservable request = inputQueue.poll(20L, TimeUnit.MICROSECONDS);
